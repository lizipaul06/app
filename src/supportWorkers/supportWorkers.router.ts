...
import { SupportWorkers,SupportWorker, SupportWorkerVisits } from "./supportWorkers.interface";
...
supportWorkersRouter.get("/:supportWorkerId", async (req: Request, res: Response) => {
...
supportWorkersRouter.get("/:supportWorkerId/visits", async (req: Request, res: Response) => {
	const supportWorkerId: number = parseInt(req.params.supportWorkerId);
  const supportWorkerVisits: SupportWorkerVisits = await SupportWorkerService.getSupportWorkerVisits(supportWorkerId);
	try {
